...
/**
 * Event is fired via RegenClientHooks (me.swirtzly.regeneration.asm.RegenClientHooks) It is fired after setRotationAngles in BipedModel via ASM Allows the manipulation of the players limbs without breaking compatibility with other mods (So far as I know)
 */
@Cancelable
