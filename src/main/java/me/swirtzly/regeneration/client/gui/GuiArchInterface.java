...
public class GuiArchInterface extends ContainerScreen {
    ...
    public GuiArchInterface(PlayerEntity player, ArchInventory archInv) {
    ...
    public void initGui() {
        ...
        GuiButtonExt btnClose = new GuiButtonExt(98, width / 2 - 30, cy + 20, 71, btnH, new TranslationTextComponent("regeneration.gui.use").getFormattedText());
        addButton(btnClose);
    }
