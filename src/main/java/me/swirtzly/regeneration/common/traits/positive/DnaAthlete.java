...
public class DnaAthlete extends DnaHandler.IDna {
    ...
    private final AttributeModifier SPEED_MODIFIER = new AttributeModifier(SPEED_ID, "SANIC_FAST", 0.95, AttributeModifier.Operation.ADDITION);
    private final UUID KNOCKBACK_ID = UUID.fromString("49906f69-7b9d-4967-aba8-901621ee76a5");
    private final AttributeModifier KNOCKBACK_MODIFIER = new AttributeModifier(KNOCKBACK_ID, "JUMPY", 0.95, AttributeModifier.Operation.ADDITION);
